...
import YumImg from "../logo/YumYum.png"
...
const Card1 = () => {
    ...
    return (
        < article className="project_card" ref={ref}>
            ...
            <h3>Food Sharing App</h3>
            <p>The site platform is dedicated to fostering a culture of sharing homemade recipes, culinary experiences, and heartfelt stories. Whether you're a seasoned chef or a kitchen newbie, you'll find a wealth of inspiration, creativity, and mouthwatering dishes to explore and enjoy. </p>
            <div className="project_link">
                <a href="https://yumyum-share.netlify.app/" target="_blank" rel="noopener noreferrer">Live Preview</a>
                <a href="https://github.com/Parnian-Zrb/FinalProjectFE" target="_blank" rel="noopener noreferrer">Github</a>
            </div>
        </ article>
    )
}
